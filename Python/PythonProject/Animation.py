...
class Animation:
    ...
    def walk_animation(self, factor=1):
        ...
        names.append("HeadYaw")
        times.append([0.1, 0.96, 1.96, 2.96])
    ...
    def question_animation(self, factor=1):
        ...
        names.append("HeadPitch")
        times.append([0.1, 1.16, 2.36, 3.56, 4.76])
