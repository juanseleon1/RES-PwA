...
public class ContaryListar extends GoalBDI{
    ...
    public ContaryListar(int id, RationalRole role, String description, GoalBDITypes type) {
        ...
        //System.out.println("Meta ContarYListar created");
    }

    @Override
    public double evaluateViability(Believes believes) throws KernellAgentEventExceptionBESA {
        //System.out.println("Meta ContarYListar evaluateViability");
        return 1.0;
    ...
    public double detectGoal(Believes believes) throws KernellAgentEventExceptionBESA {
        System.out.println("Meta ContarYListar detectGoal");
    ...
    public double evaluateContribution(StateBDI stateBDI) throws KernellAgentEventExceptionBESA {
        //System.out.println("Meta ContarYListar evaluateContribution");
    ...
    public boolean predictResultUnlegality(StateBDI agentStatus) throws KernellAgentEventExceptionBESA {
        //System.out.println("Meta ContarYListar predictResultUnlegality");
        return true;
    }
