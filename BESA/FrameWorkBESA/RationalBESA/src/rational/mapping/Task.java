...
public abstract class Task {
    ...
    public void setTaskFinalized() {
        ...
        public void setTaskInterrupted() {
        this.taskState = STATE.INTERRUPTED;
    }
...
//            }
    ...
    //Es invocado desde el que interrumpe la tarea. Es la ultima oportunidad de hacer algo antes de ser expropiada.Debe quedar listo para el llamadao a executeTask
    public abstract void interruptTask(Believes believes);

    public abstract void cancelTask(Believes believes);
    
    //Se invoca automaticamente al reiniciar al plan. Reinicializa variables de los believes. Debe quedar listo para el llamadao a executeTask.
    public  void initTask(Believes believes){
    };
}
