...
public enum ActivityServiceRequestType implements ServiceRequestType{
    RUNANIMATION("RUNANIMATION"),GOTOPOSTURE("GOTOPOSTURE"),DETECTNEWFACE("DETECTNEWFACE"),GETFACELIST("GETFACELIST"), STOPANIMATION("STOPANIMATION"),CHECKANIMATIONFINISH("CHECKANIMATIONFINISH");
