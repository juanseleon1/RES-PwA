...
public class RobotSPAgent extends ServiceProviderBESA {
    ...
    private RobotSPAgent(String alias, ResPwaAdapter adapter, StateServiceProvider ssp) throws KernelAgentExceptionBESA {
    ...
    public static RobotSPAgent buildRobotSPAgent(String alias, ResPwaAdapter adapter) throws KernelAgentExceptionBESA
    {
     return new RobotSPAgent(alias,adapter,prepareServiceProvider(adapter));
    }
