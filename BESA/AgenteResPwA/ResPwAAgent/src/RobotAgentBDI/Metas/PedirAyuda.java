...
public class PedirAyuda extends GoalBDI {
    ...
    public double detectGoal(Believes believes) throws KernellAgentEventExceptionBESA {
        ...
        if (blvs.getEstadoRobot().isRobotInicializado() && !blvs.getbEstadoInteraccion().isSistemaSuspendidoInt() && blvs.getbEstadoInteraccion().isLogged() && blvs.getbEstadoInteraccion().isAyudaActividadSolicitada()) {
            return 1;
        }
