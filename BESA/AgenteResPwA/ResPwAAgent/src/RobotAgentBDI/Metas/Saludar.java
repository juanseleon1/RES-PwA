...
public class Saludar extends GoalBDI{
    ...
    public double detectGoal(Believes believes) throws KernellAgentEventExceptionBESA {
        ...
        if (blvs.getEstadoRobot().isRobotInicializado() && blvs.getbEstadoInteraccion().isMovManoSaludo() || (blvs.getbEstadoInteraccion().isDetectaPwA() && blvs.getbEstadoInteraccion().getTiempoSinInt() > 10000) && 
