...
public class SalirDeSuspension extends GoalBDI {
    ...
    public double detectGoal(Believes believes) throws KernellAgentEventExceptionBESA {
        ...
        if (blvs.getEstadoRobot().isRobotInicializado() && blvs.getbEstadoRobot().getBatteryPerc()>30.0 && !blvs.getbEstadoRobot().getBateria() && blvs.getbEstadoInteraccion().isSistemaSuspendido()) {
                return 1.0;
        }
        return 0;
    }
