    ...
    public void create(NivelEducativo nivelEducativo) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            for (Perfilpwa perfilpwaListPerfilpwa : nivelEducativo.getPerfilpwaList()) {
                NivelEducativo oldNivelEducativoTiponiveleducativoOfPerfilpwaListPerfilpwa = perfilpwaListPerfilpwa.getNivelEducativoTiponiveleducativo();
                perfilpwaListPerfilpwa.setNivelEducativoTiponiveleducativo(nivelEducativo);
                perfilpwaListPerfilpwa = em.merge(perfilpwaListPerfilpwa);
                if (oldNivelEducativoTiponiveleducativoOfPerfilpwaListPerfilpwa != null) {
                    oldNivelEducativoTiponiveleducativoOfPerfilpwaListPerfilpwa.getPerfilpwaList().remove(perfilpwaListPerfilpwa);
                    oldNivelEducativoTiponiveleducativoOfPerfilpwaListPerfilpwa = em.merge(oldNivelEducativoTiponiveleducativoOfPerfilpwaListPerfilpwa);
                }
            }
        ...
        try {
            ...
            for (Perfilpwa perfilpwaListOldPerfilpwa : perfilpwaListOld) {
                if (!perfilpwaListNew.contains(perfilpwaListOldPerfilpwa)) {
                    perfilpwaListOldPerfilpwa.setNivelEducativoTiponiveleducativo(null);
            ...
            for (Perfilpwa perfilpwaListNewPerfilpwa : perfilpwaListNew) {
                if (!perfilpwaListOld.contains(perfilpwaListNewPerfilpwa)) {
                    NivelEducativo oldNivelEducativoTiponiveleducativoOfPerfilpwaListNewPerfilpwa = perfilpwaListNewPerfilpwa.getNivelEducativoTiponiveleducativo();
                    perfilpwaListNewPerfilpwa.setNivelEducativoTiponiveleducativo(nivelEducativo);
                    perfilpwaListNewPerfilpwa = em.merge(perfilpwaListNewPerfilpwa);
                    if (oldNivelEducativoTiponiveleducativoOfPerfilpwaListNewPerfilpwa != null && !oldNivelEducativoTiponiveleducativoOfPerfilpwaListNewPerfilpwa.equals(nivelEducativo)) {
                        oldNivelEducativoTiponiveleducativoOfPerfilpwaListNewPerfilpwa.getPerfilpwaList().remove(perfilpwaListNewPerfilpwa);
                        oldNivelEducativoTiponiveleducativoOfPerfilpwaListNewPerfilpwa = em.merge(oldNivelEducativoTiponiveleducativoOfPerfilpwaListNewPerfilpwa);
                    }
                }
            }
            em.getTransaction().commit();
    ...
    public void destroy(String id) throws NonexistentEntityException {
        ...
        try {
            ...
            for (Perfilpwa perfilpwaListPerfilpwa : perfilpwaList) {
                perfilpwaListPerfilpwa.setNivelEducativoTiponiveleducativo(null);
                perfilpwaListPerfilpwa = em.merge(perfilpwaListPerfilpwa);
            }
