...
@NamedQueries({
    ...
    @NamedQuery(name = "Frases.findByCuentoNombrecuento", query = "SELECT f FROM Frases f WHERE f.frasesPK.cuentoNombrecuento = :cuentoNombrecuento")})
public class Frases implements Serializable {
    ...
    @JoinColumn(name = "CUENTO_NOMBRECUENTO", referencedColumnName = "NOMBRECUENTO", insertable = false, updatable = false)
    ...
    public Frases(BigInteger orden, String cuentoNombrecuento) {
        this.frasesPK = new FrasesPK(orden, cuentoNombrecuento);
    }
    ...
    public String toString() {
        return "RobotAgentBDI.Believes.PerfilPwA.Frases[ frasesPK=" + frasesPK + " ]";
    }
