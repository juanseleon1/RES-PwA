...
def main(session):
    """
    this example shows the loadTopicContent method from the ALDialog API
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ip", type=str, default="127.0.0.1",
                        help="Robot's IP address. If on robot or a local Naoqi - use '127.0.0.1' (this is the default value).")
