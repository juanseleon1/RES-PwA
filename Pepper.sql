...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Estupendo, mamá!',9, 'Caperucita roja', 'INTERNALPOSPLUS', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Ten mucho cuidado, cariño. No te entretengas con nada y no hables con extraños',13, 'Caperucita roja', ' ', ' ', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Sabes que en el bosque vive el lobo y es muy peligroso',14, 'Caperucita roja', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Así lo haré, mamá, afirmó de nuevo Caperucita diciendo adiós con su manita mientras se alejaba',18, 'Caperucita roja', ' ', 'caminar', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¿A dónde vas, Caperucita?',23, 'Caperucita roja', ' ', ' ', 'http://10.195.22.103:49152/content/media/object_id/57/res_id/0');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Cada uno iremos por un camino diferente ¿te parece bien?',29, 'Caperucita roja', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¿Quién es?, gritó la mujer',33, 'Caperucita roja', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Ábreme la puerta, dijo el lobo imitando la voz de la niña',35, 'Caperucita roja', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¿Quién llama?, dijo el lobo forzando la voz como si fuera la abuelita',42, 'Caperucita roja', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Abuelita, abuelita ¡qué orejas tan grandes tienes!',49, 'Caperucita roja', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'El hombre se acercó y vio que el animal tenía la panza muy hinchada, demasiado para ser un lobo',56, 'Caperucita roja', ' ', 'caminar', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Lárgate, lobo malvado! ¡No te queremos en este bosque!',63, 'Caperucita roja', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Así podremos escondernos dentro de ella cada vez que el lobo aparezca por aquí',4, 'Los 3 cerditos', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Además así podré hacer una chimenea con la que calentarme en invierno, pensó el cerdito',13, 'Los 3 cerditos', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Se dirigió a la de paja y llamó a la puerta:',16, 'Los 3 cerditos', ' ', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Pero el cerdito echó a correr y se refugió en la casa de su hermano mediano',21, 'Los 3 cerditos', ' ', 'caminar', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'y los cerditos salieron corriendo en dirección hacia la casa de su hermano mayor',28, 'Los 3 cerditos', ' ', 'caminar', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Dentro los cerditos celebraban la resistencia de la casa de su hermano',31, 'Los 3 cerditos', 'INTERNALPOS', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¿Quien teme al lobo feroz? ¡No, no, no!',33, 'Los 3 cerditos', ' ', ' ', ' ');
...
=======
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Érase una vez una preciosa niña',1, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'que siempre llevaba una capa roja con capucha para protegerse del frío',2, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Por eso, todo el mundo la llamaba Caperucita Roja',3, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Caperucita vivía en una casita cerca del bosque',4, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Un día, la mamá de  Caperucita le dijo',5, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Hija mía, tu abuelita está enferma',6, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'He preparado una cestita con tortas y un tarrito de miel para que se la lleves',7, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Ya verás qué contenta se pone!',8, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Estupendo, mamá!',9, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Yo también tengo muchas ganas de ir a visitarla, dijo Caperucita saltando de alegría',10, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Cuando Caperucita se disponía a salir de casa',11, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'su mamá, con gesto un poco serio, le hizo una advertencia',12, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Ten mucho cuidado, cariño. No te entretengas con nada y no hables con extraños',13, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Sabes que en el bosque vive el lobo y es muy peligroso',14, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Si ves que aparece, sigue tu camino sin detenerte',15, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'No te preocupes, mamita, dijo la niña. Tendré en cuenta todo lo que me dices',16, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Está bien, contestó la mamá, confiada. Dame un besito y no tardes en regresar',17, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Así lo haré, mamá, afirmó de nuevo Caperucita diciendo adiós con su manita mientras se alejaba',18, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Cuando llegó al bosque',19, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'la pequeña comenzó a distraerse contemplando los pajaritos y recogiendo flores',20, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'No se dio cuenta de que alguien la observaba detrás de un viejo y frondoso árbol',21, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'De repente, oyó una voz dulce y zalamera',22, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¿A dónde vas, Caperucita?',23, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'La niña, dando un respingo, se giró y vio que quien le hablaba era un enorme lobo',24, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Voy a casa de mi abuelita, al otro lado del bosque',25, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Está enferma y le llevo una deliciosa merienda y unas flores para alegrarle el día',26, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Oh, eso es estupendo!, dijo el astuto lobo, Yo también vivo por allí',27, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Te echo una carrera a ver quién llega antes',28, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Cada uno iremos por un camino diferente ¿te parece bien?',29, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'La inocente niña pensó que era una idea divertida y asintió con la cabeza',30, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'No sabía que el lobo había elegido el camino más corto para llegar primero a su destino',31, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Cuando el animal  llegó a casa de la abuela, llamó a la puerta',32, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¿Quién es?, gritó la mujer',33, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Soy yo, abuelita, tu querida nieta Caperucita',34, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Ábreme la puerta, dijo el lobo imitando la voz de la niña',35, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Pasa, querida mía. La puerta está abierta, contestó la abuela',36, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'El malvado lobo entró en la casa y sin pensárselo dos veces',37, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'saltó sobre la cama y se comió a la anciana',38, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Después, se puso su camisón y su gorrito de dormir',39, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'y se metió entre las sábanas esperando a que llegara la niña',40, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Al rato, se oyeron unos golpes',41, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¿Quién llama?, dijo el lobo forzando la voz como si fuera la abuelita',42, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Soy yo, Caperucita. Vengo a hacerte una visita y a traerte unos ricos dulces para merendar',43, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Pasa, querida, estoy deseando abrazarte, dijo el lobo malvado relamiéndose',44, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'La habitación estaba en penumbra',45, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Cuando se acercó a la cama, a Caperucita le pareció que su abuela estaba muy cambiada',46, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Extrañada, le dijo: Abuelita, abuelita ¡qué ojos tan grandes tienes!',47, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Son para verte mejor, preciosa mía, contestó el lobo, suavizando la voz',48, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Abuelita, abuelita ¡qué orejas tan grandes tienes!',49, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Son para oírte mejor, querida',50, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Pero abuelita, abuelita ¡qué boca tan grande tienes!',51, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Es para comerte mejor!, gritó el lobo dando un enorme salto y comiéndose a la niña de un bocado',52, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Con la barriga llena después de tanta comida, al lobo le entró sueño',53, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Salió de la casa, se tumbó en el jardín y cayó profundamente dormido',54, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'El fuerte sonido de sus ronquidos llamó la atención de un cazador que pasaba por allí',55, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'El hombre se acercó y vio que el animal tenía la panza muy hinchada, demasiado para ser un lobo',56, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Sospechando que pasaba algo extraño, cogió un cuchillo y le rajó la tripa',57, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Se llevó una gran sorpresa cuando vio que de ella salieron sanas y salvas la abuela y la niña!',58, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Después de liberarlas, el cazador cosió la barriga del lobo',59, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'y esperaron un rato a que el animal se despertará',60, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Cuando por fin abrió los ojos, vio como los tres le rodeaban y escuchó la profunda',61, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'y amenazante voz del cazador que le gritaba enfurecido:',62, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Lárgate, lobo malvado! ¡No te queremos en este bosque!',63, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Como vuelva a verte por aquí, no volverás a contarlo!',64, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'El lobo, aterrado, puso pies en polvorosa y salió despavorido',65, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Caperucita y su abuelita, con lágrimas cayendo sobre sus mejillas, se abrazaron',66, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'El susto había pasado y la niña había aprendido una importante lección:',67, 'Caperucita roja');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'nunca más desobedecería a su mamá ni se fiaría de extraños',68, 'Caperucita roja');


INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Había una vez tres hermanos cerditos que vivían en el bosque',1, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Como el malvado lobo siempre los estaba persiguiendo para comérselos dijo un día el mayor:',2, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Tenemos que hacer una casa para protegernos de lobo',3, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Así podremos escondernos dentro de ella cada vez que el lobo aparezca por aquí',4, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'A los otros dos les pareció muy buena idea',5, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'pero no se ponían de acuerdo respecto a qué material utilizar',6, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Al final, y para no discutir, decidieron que cada uno la hiciera de lo que quisiese',7, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'El más pequeño optó por utilizar paja, para no tardar mucho y poder irse a jugar después',8, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'El mediano prefirió construirla de madera',9, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'que era más resistente que la paja y tampoco le llevaría mucho tiempo hacerla',10, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Pero el mayor pensó que aunque tardara más que sus hermanos',11, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'lo mejor era hacer una casa resistente y fuerte con ladrillos',12, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Además así podré hacer una chimenea con la que calentarme en invierno, pensó el cerdito',13, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Cuando los tres acabaron sus casas se metieron cada uno en la suya',14, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'y entonces apareció por ahí el malvado lobo',15, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Se dirigió a la de paja y llamó a la puerta:',16, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Anda cerdito se bueno y déjame entrar',17, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡No! ¡Eso ni pensarlo!',18, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Pues soplaré y soplaré y la casita derribaré!',19, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Y el lobo empezó a soplar y a estornudar, la débil casa acabó viniéndose abajo',20, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Pero el cerdito echó a correr y se refugió en la casa de su hermano mediano',21, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'que estaba hecha de madera',22, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Anda cerditos sed buenos y dejarme entrar',23, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡No! ¡Eso ni pensarlo!, dijeron los dos',24, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Pues soplaré y soplaré y la casita derribaré!',25, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'El lobo empezó a soplar y a estornudar',26, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'aunque esta vez tuvo que hacer más esfuerzos para derribar la casa al final la madera acabó cediendo',27, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'y los cerditos salieron corriendo en dirección hacia la casa de su hermano mayor',28, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'El lobo estaba cada vez más hambriento así que sopló y sopló con todas sus fuerzas',29, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'pero esta vez no tenía nada que hacer porque la casa no se movía ni siquiera un poco',30, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Dentro los cerditos celebraban la resistencia de la casa de su hermano',31, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'y cantaban alegres por haberse librado del lobo:',32, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¿Quien teme al lobo feroz? ¡No, no, no!',33, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Fuera el lobo continuaba soplando en vano, cada vez más enfadado',34, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Hasta que decidió parar para descansar y entonces reparó en que la casa tenía una chimenea',35, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( '¡Ja! ¡Pensaban que de mí iban a librarse! ¡Subiré por la chimenea y me los comeré a los tres!',36, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Pero los cerditos le oyeron, y para darle su merecido llenaron la chimenea de leña',37, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'y pusieron al fuego un gran caldero con agua',38, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'Así cuando el lobo cayó por la chimenea el agua estaba hirviendo',39, 'Los 3 cerditos');
INSERT INTO Frases (contenido,orden,Cuento_nombre) VALUES( 'se quemó tanto que salió gritando de la casa y no volvió a comer cerditos en una larga temporada',40, 'Los 3 cerditos');
