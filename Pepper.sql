...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'que siempre llevaba una capa roja con capucha para protegerse del frío',2, 'Caperucita roja', ' ', 'SHOWWARDROBE', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Caperucita vivía en una casita cerca del bosque',4, 'Caperucita roja', ' ', 'FRAGCONVRIGHT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Hija mía, tu abuelita está enferma',6, 'Caperucita roja', 'INTERNALNEGPLUS', 'FRAGCONVLEFT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Estupendo, mamá!',9, 'Caperucita roja', 'INTERNALPOSPLUS', 'HAPPINESS', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Cuando Caperucita se disponía a salir de casa',11, 'Caperucita roja', ' ', 'COMPLETECONV', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Si ves que aparece, sigue tu camino sin detenerte',15, 'Caperucita roja', ' ', 'FRAGCONVLEFT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'la pequeña comenzó a distraerse contemplando los pajaritos y recogiendo flores',20, 'Caperucita roja', ' ', 'EXPLORE', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'De repente, oyó una voz dulce y zalamera',22, 'Caperucita roja', ' ', 'HOWL', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¿A dónde vas, Caperucita?',23, 'Caperucita roja', ' ', 'COMPLETECONV', 'http://10.195.22.103:49152/content/media/object_id/57/res_id/0');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Voy a casa de mi abuelita, al otro lado del bosque',25, 'Caperucita roja', ' ', 'FRAGCONVLEFT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Oh, eso es estupendo!, dijo el astuto lobo, Yo también vivo por allí',27, 'Caperucita roja', 'INTERNALPOS', 'FRAGCONVRIGHT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Cada uno iremos por un camino diferente ¿te parece bien?',29, 'Caperucita roja', ' ', 'FRAGCONVLEFT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'No sabía que el lobo había elegido el camino más corto para llegar primero a su destino',31, 'Caperucita roja', ' ', 'COMPLETECONV', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¿Quién es?, gritó la mujer',33, 'Caperucita roja', ' ', 'FRAGCONVLEFT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'El malvado lobo entró en la casa y sin pensárselo dos veces',37, 'Caperucita roja', ' ', 'FRAGCONVLEFT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Después, se puso su camisón y su gorrito de dormir',39, 'Caperucita roja', ' ', 'YAWN', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Pasa, querida, estoy deseando abrazarte, dijo el lobo malvado relamiéndose',44, 'Caperucita roja', ' ', 'COMPLETECONV', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Extrañada, le dijo: Abuelita, abuelita ¡qué ojos tan grandes tienes!',47, 'Caperucita roja', ' ', 'BIGEYES', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Abuelita, abuelita ¡qué orejas tan grandes tienes!',49, 'Caperucita roja', ' ', 'FRAGCONVLEFT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Es para comerte mejor!, gritó el lobo dando un enorme salto y comiéndose a la niña de un bocado',52, 'Caperucita roja', 'INTERNALNEG', 'EAT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Salió de la casa, se tumbó en el jardín y cayó profundamente dormido',54, 'Caperucita roja', ' ', 'FRAGCONVLEFT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Se llevó una gran sorpresa cuando vio que de ella salieron sanas y salvas la abuela y la niña!',58, 'Caperucita roja', ' ', 'FRAGCONVRIGHT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'y esperaron un rato a que el animal se despertará',60, 'Caperucita roja', ' ', 'COMPLETECONV', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'El lobo, aterrado, puso pies en polvorosa y salió despavorido',65, 'Caperucita roja', 'INTERNALNEG', 'FRAGCONVLEFT', ' ');
