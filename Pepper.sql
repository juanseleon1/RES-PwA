...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Hija mía, tu abuelita está enferma',6, 'Caperucita roja','ABUELA_ENFERMAR_NULL', 'FRAGCONVLEFT', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'He preparado una cestita con tortas y un tarrito de miel para que se la lleves',7, 'Caperucita roja','CAPERUCITA_LLEVAR_REGALO', ' ', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Ya verás qué contenta se pone!',8, 'Caperucita roja', ' ', ' ', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Estupendo, mamá!',9, 'Caperucita roja','CAPERUCITA_EMOCIONAR_NULL', 'HAPPINESS', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Yo también tengo muchas ganas de ir a visitarla, dijo Caperucita saltando de alegría',10, 'Caperucita roja','CAPERUCITA_ALEGRARSE_NULL', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'su mamá, con gesto un poco serio, le hizo una advertencia',12, 'Caperucita roja', ' ', ' ', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Ten mucho cuidado, cariño. No te entretengas con nada y no hables con extraños',13, 'Caperucita roja','CAPERUCITA_ASUSTADA_NULL', 'FRAGCONVRIGHT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'No te preocupes, mamita, dijo la niña. Tendré en cuenta todo lo que me dices',16, 'Caperucita roja','CAPERUCITA_ASUSTADA_NULL', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'la pequeña comenzó a distraerse contemplando los pajaritos y recogiendo flores',20, 'Caperucita roja','CAPERUCITA_OBSERVAR_NATURALEZA', 'EXPLORE', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'No se dio cuenta de que alguien la observaba detrás de un viejo y frondoso árbol',21, 'Caperucita roja','LOBO_OBSERVAR_CAPERUCITA', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¿A dónde vas, Caperucita?',23, 'Caperucita roja','LOBO_HABLA_CAPERUCITA', 'COMPLETECONV', 'http://10.195.22.103:49152/content/media/object_id/57/res_id/0');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Oh, eso es estupendo!, dijo el astuto lobo, Yo también vivo por allí',27, 'Caperucita roja','LOBO_AMENAZAR_CAPERUCITA', 'FRAGCONVRIGHT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'La inocente niña pensó que era una idea divertida y asintió con la cabeza',30, 'Caperucita roja','CAPERUCITA_APRECIAR_IDEA', ' ', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'No sabía que el lobo había elegido el camino más corto para llegar primero a su destino',31, 'Caperucita roja','LOBO_TRAICIONAR_CAPERUCITA', 'COMPLETECONV', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Ábreme la puerta, dijo el lobo imitando la voz de la niña',35, 'Caperucita roja','LOBO_ENGANAR_ABUELA', 'FRAGCONVRIGHT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'saltó sobre la cama y se comió a la anciana',38, 'Caperucita roja','LOBO_DEVORAR_ABUELA', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¿Quién llama?, dijo el lobo forzando la voz como si fuera la abuelita',42, 'Caperucita roja','LOBO_ENGANAR_CAPERUCITA', 'QUESTION', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Cuando se acercó a la cama, a Caperucita le pareció que su abuela estaba muy cambiada',46, 'Caperucita roja','CAPERUCITA_SOSPECHAR_NULL', ' ', 'http://10.195.22.103:49152/content/media/object_id/9/res_id/0');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Extrañada, le dijo: Abuelita, abuelita ¡qué ojos tan grandes tienes!',47, 'Caperucita roja','CAPERUCITA_SOSPECHAR_NULL', 'BIGEYES', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Son para verte mejor, preciosa mía, contestó el lobo, suavizando la voz',48, 'Caperucita roja','CAPERUCITA_SOSPECHAR_NULL', ' ', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Es para comerte mejor!, gritó el lobo dando un enorme salto y comiéndose a la niña de un bocado',52, 'Caperucita roja','LOBO_DEVORAR_CAPERUCITA', 'EAT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Salió de la casa, se tumbó en el jardín y cayó profundamente dormido',54, 'Caperucita roja','LOBO_DESCANSAR_NULL', 'FRAGCONVLEFT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'El hombre se acercó y vio que el animal tenía la panza muy hinchada, demasiado para ser un lobo',56, 'Caperucita roja','HOMBRE_SORPRENDER_NULL', 'WALK', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Se llevó una gran sorpresa cuando vio que de ella salieron sanas y salvas la abuela y la niña!',58, 'Caperucita roja','FAMILIAR_ESCAPAR_NULL', 'FRAGCONVRIGHT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'y esperaron un rato a que el animal se despertará',60, 'Caperucita roja','LOBO_ENFERMAR_NULL', 'COMPLETECONV', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( '¡Lárgate, lobo malvado! ¡No te queremos en este bosque!',63, 'Caperucita roja','HOMBRE_GRITAR_LOBO', 'FRAGCONVRIGHT', ' ');
...
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'El lobo, aterrado, puso pies en polvorosa y salió despavorido',65, 'Caperucita roja','LOBO_HUIR_NULL', 'FRAGCONVLEFT', ' ');
INSERT INTO Frases (contenido,orden,Cuento_nombre,emotionalEvent,accion,urlImagen) VALUES( 'Caperucita y su abuelita, con lágrimas cayendo sobre sus mejillas, se abrazaron',66, 'Caperucita roja','FAMILIA_ABRAZAR_NULL', ' ', 'http://10.195.22.103:49152/content/media/object_id/51/res_id/0');
...
update eventinfluence set eventinfluence=0.7;
commit;