...
--------------------------------------------------------
DROP TABLE "IS784921"."ACTIVIDADPWA";
DROP TABLE "IS784921"."ACTIVIDADRUTINARIA";
DROP TABLE "IS784921"."ACTXPREFERENCIA";
DROP TABLE "IS784921"."BOOKS";
DROP TABLE "IS784921"."CANCION";
DROP TABLE "IS784921"."CAUSADEMENCIA";
DROP TABLE "IS784921"."CDR";
DROP TABLE "IS784921"."CUENTO";
DROP TABLE "IS784921"."CUIDADOR";
DROP TABLE "IS784921"."DIFICULTAD";
DROP TABLE "IS784921"."ENRIQ";
DROP TABLE "IS784921"."ESTADOCIVIL";
DROP TABLE "IS784921"."FAMILIAR";
DROP TABLE "IS784921"."FAMILIARES";
DROP TABLE "IS784921"."FRASES";
DROP TABLE "IS784921"."GENERO";
DROP TABLE "IS784921"."LISTATAGS";
DROP TABLE "IS784921"."NIVEL_EDUCATIVO";
DROP TABLE "IS784921"."PERFIL_MEDICO";
DROP TABLE "IS784921"."PERFIL_PREFERENCIA";
DROP TABLE "IS784921"."PERFILPWA";
DROP TABLE "IS784921"."PREFERENCIACANCION";
DROP TABLE "IS784921"."PREFERENCIAXCUENTO";
DROP TABLE "IS784921"."REGISTROACTIVIDAD";
DROP TABLE "IS784921"."TAGS";
DROP TABLE "IS784921"."PERFIL_MEDICO";
DROP TABLE "IS784921"."ACTIVIDADPWA";
DROP TABLE "IS784921"."DIFICULTAD";
DROP TABLE "IS784921"."PERFIL_PREFERENCIA";
...
SET DEFINE OFF;
Insert into IS784921.ACTXPREFERENCIA (ACTIVIDADPWA_ID,PERFIL_PREFERENCIA_CEDULA,ACTIVA,GUSTO,ENRIQ,DIFICULTAD_DIFICULTAD) values ('0','123456789','1','0,8','5',null);
Insert into IS784921.ACTXPREFERENCIA (ACTIVIDADPWA_ID,PERFIL_PREFERENCIA_CEDULA,ACTIVA,GUSTO,ENRIQ,DIFICULTAD_DIFICULTAD) values ('1','123456789','1','0,5','2',null);
commit;
REM INSERTING into IS784921.BOOKS
SET DEFINE OFF;
Insert into IS784921.BOOKS (BOOK_ID,TITLE,AUTHOR_LAST_NAME,AUTHOR_FIRST_NAME,RATING) values ('qweqwe','qweqwe','qweqwe',null,null);
Insert into IS784921.BOOKS (BOOK_ID,TITLE,AUTHOR_LAST_NAME,AUTHOR_FIRST_NAME,RATING) values ('123','asdas','asdasd',null,null);
Insert into IS784921.BOOKS (BOOK_ID,TITLE,AUTHOR_LAST_NAME,AUTHOR_FIRST_NAME,RATING) values ('hp7','hp7','hp7','hp7','7');
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "IS784921"."CDR_PK" ON "IS784921"."CDR" ("PERFIL_MEDICO_CEDULA") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "ESTUDIANTES" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "IS784921"."CDR" MODIFY ("PERFIL_MEDICO_CEDULA" NOT NULL ENABLE);
  ALTER TABLE "IS784921"."CDR" ADD CONSTRAINT "CDR_PK" PRIMARY KEY ("PERFIL_MEDICO_CEDULA")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "ESTUDIANTES"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "IS784921"."ENRIQ" MODIFY ("CANCION_NOMBRE" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "IS784921"."CDR" ADD CONSTRAINT "CDR_PERFIL_MEDICO_FK" FOREIGN KEY ("PERFIL_MEDICO_CEDULA")
	  REFERENCES "IS784921"."PERFIL_MEDICO" ("PERFILPWA_CEDULA") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "IS784921"."ENRIQ" ADD CONSTRAINT "ENRIQ_CANCION_FK" FOREIGN KEY ("CANCION_NOMBRE")
	  REFERENCES "IS784921"."CANCION" ("NOMBRE") ENABLE;
  ALTER TABLE "IS784921"."ENRIQ" ADD CONSTRAINT "ENRIQ_FRASES_FK" FOREIGN KEY ("FRASES_ORDEN", "FRASES_NOMBRE")
