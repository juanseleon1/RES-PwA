--------------------------------------------------------
-- Archivo creado  - miércoles-noviembre-18-2020   
--------------------------------------------------------
DROP TABLE "RESPWA1"."ACTIVIDADPWA";
DROP TABLE "RESPWA1"."ACTIVIDADRUTINARIA";
DROP TABLE "RESPWA1"."ACTXPREFERENCIA";
DROP TABLE "RESPWA1"."BOOKS";
DROP TABLE "RESPWA1"."CANCION";
DROP TABLE "RESPWA1"."CAUSADEMENCIA";
DROP TABLE "RESPWA1"."CDR";
DROP TABLE "RESPWA1"."CUENTO";
DROP TABLE "RESPWA1"."CUIDADOR";
DROP TABLE "RESPWA1"."DIFICULTAD";
DROP TABLE "RESPWA1"."ENRIQ";
DROP TABLE "RESPWA1"."ESTADOCIVIL";
DROP TABLE "RESPWA1"."FAMILIAR";
DROP TABLE "RESPWA1"."FAMILIARES";
DROP TABLE "RESPWA1"."FRASES";
DROP TABLE "RESPWA1"."GENERO";
DROP TABLE "RESPWA1"."LISTATAGS";
DROP TABLE "RESPWA1"."NIVEL_EDUCATIVO";
DROP TABLE "RESPWA1"."PERFIL_MEDICO";
DROP TABLE "RESPWA1"."PERFIL_PREFERENCIA";
DROP TABLE "RESPWA1"."PERFILPWA";
DROP TABLE "RESPWA1"."PREFERENCIACANCION";
DROP TABLE "RESPWA1"."PREFERENCIAXCUENTO";
DROP TABLE "RESPWA1"."REGISTROACTIVIDAD";
DROP TABLE "RESPWA1"."TAGS";
DROP TABLE "RESPWA1"."PERFIL_MEDICO";
DROP TABLE "RESPWA1"."ACTIVIDADPWA";
DROP TABLE "RESPWA1"."DIFICULTAD";
DROP TABLE "RESPWA1"."PERFIL_PREFERENCIA";
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."ACTIVIDADPWA" 
   (	"ID" NUMBER(*,0), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."ACTIVIDADRUTINARIA" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."ACTXPREFERENCIA" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."CAUSADEMENCIA" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."CDR" 
   (	"MEMORIA" NUMBER(*,0), 
	...
	"PERFIL_MEDICO_CEDULA" VARCHAR2(30 CHAR)
   ) SEGMENT CREATION DEFERRED 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
 NOCOMPRESS LOGGING
  ;
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."DIFICULTAD" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."ESTADOCIVIL" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."FAMILIARES" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."LISTATAGS" 
   (	"CANCION_NOMBRE" VARCHAR2(20 CHAR), 
	"TAGS_ID" NUMBER(*,0)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."NIVEL_EDUCATIVO" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."PERFIL_MEDICO" 
   (	"PERFILPWA_CEDULA" VARCHAR2(30 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."PERFIL_PREFERENCIA" 
   (	"PERFILPWA_CEDULA" VARCHAR2(30 CHAR), 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."PERFILPWA" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."PREFERENCIACANCION" 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."PREFERENCIAXCUENTO" 
   (	"PERFIL_PREFERENCIA_PERFILPWA_CEDULA" VARCHAR2(30 CHAR), 
	"CUENTO_NOMBRE" VARCHAR2(15 CHAR)
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 
...
--------------------------------------------------------
  ...
  CREATE TABLE "RESPWA1"."REGISTROACTIVIDAD" 
   (	"FECHA" DATE, 
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ;
REM INSERTING into RESPWA1.ACTIVIDADPWA
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.ACTIVIDADRUTINARIA
SET DEFINE OFF;
REM INSERTING into RESPWA1.ACTXPREFERENCIA
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.BOOKS
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.CANCION
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.CAUSADEMENCIA
SET DEFINE OFF;
Insert into RESPWA1.CAUSADEMENCIA (CONDICION) values ('Parkinson');
commit;
REM INSERTING into RESPWA1.CDR
SET DEFINE OFF;
REM INSERTING into RESPWA1.CUENTO
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.CUIDADOR
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.DIFICULTAD
SET DEFINE OFF;
REM INSERTING into RESPWA1.ENRIQ
SET DEFINE OFF;
REM INSERTING into RESPWA1.ESTADOCIVIL
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.FAMILIAR
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.FAMILIARES
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.FRASES
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.GENERO
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.LISTATAGS
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.NIVEL_EDUCATIVO
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.PERFIL_MEDICO
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.PERFIL_PREFERENCIA
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.PERFILPWA
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.PREFERENCIACANCION
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.PREFERENCIAXCUENTO
SET DEFINE OFF;
...
commit;
REM INSERTING into RESPWA1.REGISTROACTIVIDAD
SET DEFINE OFF;
REM INSERTING into RESPWA1.TAGS
SET DEFINE OFF;
